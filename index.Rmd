...
# d-connection
dp1 <- ggdag_ov %>%
  ggdag_dconnected(from = "X", to = "Y", controlling_for = c("X")) + labs(title = "Omitted variable confounding")
...
pdm <-
  ggdag::ggdag_dconnected(dag_1, from = "X", to = "Y", controlling_for = "X") + labs(title = "Y ~ X (no Z)")
